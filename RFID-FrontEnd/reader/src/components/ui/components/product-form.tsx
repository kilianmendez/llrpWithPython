...
import { Upload, Tag, Save, AlertTriangle } from "lucide-react"
...
export function ProductForm() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      setError("Error creating product. Check your connection or login session.")
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
                  <div className="relative h-32 w-32 flex-shrink-0 overflow-hidden rounded-md border border-dashed border-gray-300 dark:border-gray-700">
                    {imagePreview ? (
                      <img
                        src={imagePreview}
                        alt="Preview"
      ...
      {/* ✅ Toast de error */}
      {error && (
        <div className="fixed bottom-4 right-4 flex items-center gap-2 rounded bg-red-600 text-white px-4 py-2 shadow-lg z-50">
